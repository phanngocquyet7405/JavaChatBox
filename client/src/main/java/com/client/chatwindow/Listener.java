...
public class Listener implements Runnable{
    ...
    public Listener(String hostname, int port_socket,int port_sql, String username, String password,String picture, ChatController controller) {
        this.hostname = hostname;
        this.port_socket = port_socket;
        this.port_sql = port_sql;
